...
from assets import pos_H2O, elem_H2O, forward_H2O, backward_H2O
from assets import pos_H2, forward_H2, backward_H2
from assets import params_GeSe, forward_GeSe, backward_GeSe, elem_GeSe
